...
public class FueraDeRango {
    ...
    private static void arrayFueraDeRango() {
        ...
        System.out.println("El cuardo número es: " + numeros[4]);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("¡También ha fallado! " + e.getMessage());
        }

        System.out.println("La suma es " + sumaHasta20(new int[]{5, 10, 1, 7, 3, 8}));
        System.out.println("La suma es " + sumaHasta20(new int[]{5, 1, 7, 3, 2, 0}));
